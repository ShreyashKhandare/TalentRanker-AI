...
# Use sklearn's TF-IDF for text similarity - NO sentence-transformers
from sklearn.feature_extraction.text import TfidfVectorizer
from sklearn.metrics.pairwise import cosine_similarity

print("ULTIMATE FIX: Pure sklearn TF-IDF - no ML dependencies")

class SimpleEmbedder:
    """TF-IDF based text similarity - no heavy ML models"""
...
print("ULTIMATE FIX: TF-IDF embedder ready")
